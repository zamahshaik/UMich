...
# Therefore the dummy 'most frequent' classifier always predicts class 0 
...
# show the probability of psoitive class for 20 instances
y_proba_list
...
dataset = load_digits()
# again, make this a binary class with digit '1' as a positive class
...
plt.title("SVC, class_weight = 'balanced', optimized_for_accuracy")
plt.show()
